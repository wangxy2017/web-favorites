...
public class RegisterController {
    ...
    public ApiResponse register(@RequestBody User user) {
        ...
        if (userService.findByUsernameOrEmail(user.getUsername(), user.getEmail()) == null) {
            ...
            recommends.add(new Favorites(null, "百度搜索", "https://www.baidu.com/favicon.ico", "https://www.baidu.com/", category.getId(), user1.getId(), PinYinUtils.toPinyin("百度搜索"),null));
            recommends.add(new Favorites(null, "谷歌翻译", "https://translate.google.cn/favicon.ico", "https://translate.google.cn/", category.getId(), user1.getId(), PinYinUtils.toPinyin("谷歌翻译"),null));
